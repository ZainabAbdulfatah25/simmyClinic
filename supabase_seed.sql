...
UPDATE public.profiles SET specialty = 'Obstetrics & Gynaecology', schedule = 'Mon - Wed (9am - 2pm)', experience = '8 Years', reg_no = 'MDCN/8431', clinic_room = 'Room 102, West Wing', consultation_rate = '₦3,000', consultation_duration = '30 mins', services = ARRAY['Online Consultation', 'Physical Consultation'], level = 'Junior Doctor', verified = true, terms_accepted = true, terms_accepted_at = NOW() WHERE email = 'fatima@simmycare.com';
